 ...
 * @group built
 */
class DeleteLocaleCommandTest extends ApiClientTestCase
{

    /**
     * Delete a project locale
     */
    public function testDeleteLocaleCommandSuccess()
    {
        $service = $this->getServiceDescription();
        $query = new MockRequest('deleteLocale', $service);
        ...
        $result = $client->deleteLocale($query->toArray());
